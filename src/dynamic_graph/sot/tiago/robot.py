...
class AbstractRobot(object):
    ...
    OperationalPoints = ['wrist', 'left-wheel', 'right-wheel', 'footprint', 'mobilebase', 'gaze']
    """
    ...
    """
    tracedSignals = {'dynamic': ["position", "velocity", "acceleration"], 'device': ['control', 'state']}
    """
    Robot timestep
    """
    timeStep = 0.005
