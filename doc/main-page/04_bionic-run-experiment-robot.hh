...
- The best practice is to test the movement on Gazebo before performing on the
real robot \n
...
- Run your experiment as you do it in simulation. For instance, on development
machine \n
