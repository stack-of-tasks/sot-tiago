...
On the robot:
\li \ref sot_tiago_bionic_03_install_robot "Installation"
\li \ref sot_tiago_bionic_04_run_experiment_robot "Experiment"

Running Agimus experiments:
\li \ref sot_tiago_bionic_05_build_sot_hpp_agimus
